        ...
        child: Container(height:500,width: MediaQuery.of(context).size.width /1, decoration: BoxDecoration(color: Colors.grey[200],borderRadius: BorderRadius.circular(8.0),
          ...
          child: Column(
            children: [
              ...
              },child: Text('Continue shopping',style: TextStyle(color: Colors.white),),color: Colors.pinkAccent.withOpacity(0.8),shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0)))
            ],
          ),
        ),
      ),
